...
var Particle = function () {
	...
	_createClass(Particle, [{
		...
		value: function move(timeScale, noise) {
			...
			this.currentColor = _Color2.default.lerp(this.color.start, this.color.end, this.percentComplete);
...
var _Effect2 = __webpack_require__(6);
...
var _Wisp = __webpack_require__(11);
...
var _Particle2 = __webpack_require__(7);
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // wispy tendril particle
...
var Color = function () {
	...
	_createClass(Color, null, [{
		key: 'lerp',
		value: function lerp(startColor, endColor, t) {
			var startColorType = this.getColorType(startColor);
			var endColorType = this.getColorType(endColor);

			startColor = this.decomposeColor(startColor, startColorType);
			endColor = this.decomposeColor(endColor, endColorType);

			var lerpColor = {
				x: _Ease2.default.lerp(startColor.x, endColor.x, t),
				y: _Ease2.default.lerp(startColor.y, endColor.y, t),
				z: _Ease2.default.lerp(startColor.z, endColor.z, t),
				a: _Ease2.default.lerp(startColor.a, endColor.a, t)
			};
		...
		key: 'recomposeColor',
		value: function recomposeColor(color, type) {
			switch (type) {
				case 'hex':
					// TODO: Handle Hex
					return '#ff0000';
