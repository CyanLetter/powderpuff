...
var _Powderpuff = __webpack_require__(7);
...
var _FastBlur = __webpack_require__(11);
	...
	_createClass(Radial, [{
		...
		value: function makeRings() {
			...
			for (var _i3 = 0; _i3 < 50; _i3++) {
				var _randColor3 = this.theme[Math.floor(Math.random() * this.theme.length)];
				var newHeight = 200 + Math.random() * 400;
				var _newParticle3 = new _Box2.default(this.pctx, {
					lifetime: 3000,
					xPos: centerX,
					yPos: centerY,
					width: 2,
					...
					drag: 0.02,
					startColor: _randColor3.start,
					endColor: _randColor3.end
					// noiseType: 'random',
					// noiseAmount: 1
				});

				this.activeParticles.push(_newParticle3);
			}
		}
...
var Box = function (_Particle) {
	...
	function Box(context, options) {
		...
		_this.angularVelocity = options.angularVelocity || 0;
